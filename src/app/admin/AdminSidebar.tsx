...
export default function AdminSidebar({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex min-h-screen bg-[#f8fafc]">
            {/* Sidebar */}
            <aside className="w-64 bg-slate-900 text-white fixed h-full flex flex-col p-6">
                <div className="flex items-center gap-3 mb-10 px-2">
                    <div className="w-8 h-8 bg-bis-red rounded-lg flex items-center justify-center font-black">B</div>
                    <span className="font-black text-lg uppercase tracking-tighter">BIS Admin</span>
                </div>
